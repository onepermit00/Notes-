    ...
    <div style={{ minHeight: '100vh', background: BG, fontFamily: INTER, position: 'relative' }}>
      ...
      <div style={{ padding: '20px 20px 80px', display: 'flex', flexDirection: 'column', gap: 20, position: 'relative', zIndex: 1 }}>
        ...
        <div style={{ ...glassCard, padding: 16 }}>
          ...
          <button style={{ width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '12px 14px', background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 12, cursor: 'pointer' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
              ...
              <div style={{ textAlign: 'left' }}>
                ...
                <p style={{ fontSize: 12, color: MUTED, marginTop: 2 }}>Visa ending in 4242</p>
              </div>
            </div>
        ...
        {/* Recent Transactions */}
        <div>
          <p style={{ fontSize: 11, fontWeight: 700, color: MUTED, letterSpacing: '0.14em', marginBottom: 12 }}>Recent Transactions</p>
              ...
              <div key={idx} style={{ ...glassCard, padding: 16, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                  <div style={{ width: 40, height: 40, borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', background: isCaregiver ? `${GREEN}20` : 'rgba(255,255,255,0.07)' }}>
                    <DollarSign size={20} color={isCaregiver ? GREEN : MUTED} />
                  </div>
                  <div>
                    <p style={{ fontWeight: 600, color: 'white', fontSize: 14 }}>{tx.desc}</p>
                    <p style={{ fontSize: 12, color: MUTED, marginTop: 2 }}>Completed</p>
                  </div>
                </div>
