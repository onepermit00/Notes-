            ...
            <>
              ...
              <div style={{ background:'#111827', padding: isMobile ? '14px 20px' : '20px 32px 18px' }}>
                {isMobile ? (
                  <div style={{ display:'flex', justifyContent:'space-between', alignItems:'flex-start' }}>
                    <div>
                      <div style={{ fontFamily:INTER, fontSize:10, fontWeight:800, color:'rgba(255,255,255,0.4)', letterSpacing:'0.14em', textTransform:'uppercase', marginBottom:4 }}>The Front desk | Concierge</div>
                      ...
                      <div style={{ fontFamily:INTER, fontSize:11, color:'rgba(255,255,255,0.50)' }}>{isPhone ? '215.488.1306' : 'O:215.488.1306 | Thehannahconcierge@greystar.com'}</div>
                    </div>
                  ...
                  <div style={{ display:'flex', justifyContent:'space-between', alignItems:'flex-start' }}>
                    <div>
                      <div style={{ fontFamily:INTER, fontSize:10, fontWeight:800, color:'rgba(255,255,255,0.4)', letterSpacing:'0.14em', textTransform:'uppercase', marginBottom:5 }}>The Front desk | Concierge</div>
                      ...
                      <div style={{ fontFamily:INTER, fontSize:11, color:'rgba(255,255,255,0.55)' }}>O:215.488.1306 | Thehannahconcierge@greystar.com</div>
                    </div>
