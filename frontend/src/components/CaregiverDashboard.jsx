              ...
              <motion.div key={activeTab}
                ...
                style={{
                  ...
                  ...(activeTab === 'calendar'
                    ...
                    : { width: Math.min(isMobile ? 700 : 700, window.innerWidth - (isMobile ? 32 : 280)) }),
        ...
        {showContacts && (
          <>
            ...
            <motion.div key="ec-panel"
              ...
              transition={{ type: 'spring', damping: 32, stiffness: 300 }}
              style={{ position: 'fixed', right: 16, top: 16, bottom: 16, width: Math.min(isMobile ? 700 : 700, window.innerWidth - (isMobile ? 32 : 280)), background: BG, zIndex: 66, display: 'flex', flexDirection: 'column', borderRadius: 24, overflow: 'hidden', boxShadow: '0 24px 64px rgba(0,0,0,0.20)' }}>
        ...
        {showPkgAudit && (
          <>
            ...
            <motion.div key="pkgaudit-panel"
              initial={{ x: 620 }} animate={{ x: 0 }} exit={{ x: 620 }}
              transition={{ type: 'spring', damping: 32, stiffness: 300 }}
              style={{ position: 'fixed', right: 16, top: 16, bottom: 16, width: Math.min(isMobile ? 700 : 700, window.innerWidth - (isMobile ? 32 : 280)), background: BG, zIndex: 61, display: 'flex', flexDirection: 'column', borderRadius: 24, overflow: 'hidden', boxShadow: '0 24px 64px rgba(0,0,0,0.20)' }}>
